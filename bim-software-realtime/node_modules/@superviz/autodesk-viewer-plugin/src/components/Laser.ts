...
export class Laser {
  constructor(viewer: Autodesk.Viewing.GuiViewer3D, colorIndex: number, laserOrigin: Vector3) {
    this.viewer = viewer;
    ...
    this.generateMaterial(colorIndex);
  }
  ...
  public setColorIndex(index: number) {
    if (index !== this.colorIndex && index !== undefined) {
      this.generateMaterial(index);
  ...
  private generateMaterial(colorIndex) {
