...
import { AnnotationParams, CommentParams, CreateOrUpdateParticipantParams, FetchAnnotationsParams, MentionParams } from './types';
export default class ApiService {
    ...
    static fetchParticipantsByGroup(groupId: string): Promise<any>;
    static createMentions(mentionParams: MentionParams): Promise<any>;
}
